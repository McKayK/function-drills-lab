...
const add = (num1, num2) => {
  let withNumber1 = parseInt(num1)
  let withNumber2 = parseInt(num2)
  return num1 + num2
}

let sum = add(3, 5)
let sum2 = add(500, 333)
...
let nameGreeting3 = nameCheck("McKay")
...
const greatMovie = bestMovie("The Fellowship of the Ring")
...
const emailCheck = (email) => {
  let result = 'Must provide a valid email address'
  email.trim()
  if(email.includes('@')){
...
// myEmail = emailCheck('mckaykleinman@yahoo.com')
...
const wallet2 = (budget) => {
  let frogs = Math.floor(budget / 3)
  return frogs
}

let totalFrogs2 = wallet2(4)
...
const arrayIsAscending = sequential(sampleArray)
